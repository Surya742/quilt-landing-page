              ...
              <div className="section-title ms-lg-5">
                ...
                <ul className="list-unstyled text-dark">
                  <li className="mb-0">
                    ...
                    Add <span className="text-success">friends</span>
                  </li>
                  <li className="mb-0">
                    <span className="text-success h5 me-2">
                      <i className="uil uil-check-circle align-middle"></i>
                    </span>
                    Send <span className="text-success">Messages</span> and{' '}
                    <span className="text-success">Crypto Currencies</span>
                  </li>
                  <li className="mb-0">
                    <span className="text-success h5 me-2">
                      <i className="uil uil-check-circle align-middle"></i>
                    </span>
                    Trade <span className="text-success">NFTs</span>
                  </li>
                  <li className="mb-0">
                    <span className="text-success h5 me-2">
                      <i className="uil uil-check-circle align-middle"></i>
                    </span>
                    Build <span className="text-success">Communities</span>
                  </li>
                </ul>
                <a
